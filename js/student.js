...
// Dialog open/close functions for failed, incomplete, and dropped subjects
function openFailedSubjectsDialog() {
    var dialog = document.getElementById('failedSubjectsDialog');
...
function openIncompleteSubjectsDialog() {
    var dialog = document.getElementById('incompleteSubjectsDialog');
    dialog.classList.remove('hidden');
    dialog.classList.add('flex');
    document.body.style.overflow = 'hidden';
}
...
function openDroppedSubjectsDialog() {
    var dialog = document.getElementById('droppedSubjectsDialog');
    dialog.classList.remove('hidden');
    dialog.classList.add('flex');
    document.body.style.overflow = 'hidden';
}

function closeDroppedSubjectsDialog() {
    var dialog = document.getElementById('droppedSubjectsDialog');
    dialog.classList.add('hidden');
    dialog.classList.remove('flex');
    document.body.style.overflow = 'auto';
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('droppedSubjectsDialog').addEventListener('click', function(e) {
        if (e.target === this) {
            closeDroppedSubjectsDialog();
        }
    });
}); 