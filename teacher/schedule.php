        ...
        <div class="flex-1 flex flex-col m-2 lg:m-5">
            ...
            <div class="flex flex-col lg:flex-row items-center justify-between bg-green-600 text-white rounded-2xl p-4 lg:p-8 mb-6 lg:mb-8 shadow gap-4">
                <div class="w-full lg:w-auto text-center lg:text-left">
                    ...
                    <div class="text-sm lg:text-base">Access your designated teaching schedule by selecting a program below.</div>
                </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-6 mb-6 lg:mb-8">
                ...
                <a href="https://drive.google.com/drive/folders/1kaYz88_Eur4S1MlFs-D0OyG-E1zwryZj" target="_blank">
                <div  class="bg-white rounded-xl p-4 lg:p-6 shadow text-center">
                    ...
                    <div class="text-gray-500 text-sm lg:text-base font-bold">BSCS</div>
                </div>
                </a>

                <a href="https://drive.google.com/drive/folders/1mLrNkvWDSO0mE5AwRuYUeoJSOVTq904z" target="_blank">
                <div class="bg-white rounded-xl p-4 lg:p-6 shadow text-center">
                    <div class="text-2xl lg:text-3xl text-red-500 font-bold mb-2">
                        <i class="fas fa-calendar-alt"></i>
                    </div>
                    <div class="text-gray-500 text-sm lg:text-base font-bold">BSIT</div>
                </div>
                </a>

                <a href="https://drive.google.com/drive/folders/1qgYzp99UDLWF95EBQVX4OsliaTIug0ks" target="_blank">
                <div class="bg-white rounded-xl p-4 lg:p-6 shadow text-center">
                    <div class="text-2xl lg:text-3xl text-green-500 font-bold mb-2">
                        <i class="fas fa-calendar-alt"></i>
                    </div>
                    <div class="text-gray-500 text-sm lg:text-base font-bold">BSCE</div>
                </div>
                </a>

                <a href="https://drive.google.com/drive/folders/1UsRe1LC8NglZWgi_NHrHpQaoMp5hns-p" target="_blank">
                <div class="bg-white rounded-xl p-4 lg:p-6 shadow text-center">
                    <div class="text-2xl lg:text-3xl text-purple-500 font-bold mb-2">
                        <i class="fas fa-calendar-alt"></i>
                    </div>
                    <div class="text-gray-500 text-sm lg:text-base font-bold">BSChemE</div>
                </div>
                </a>

                <a href="https://drive.google.com/drive/folders/1sMp-h41U-rmtrPEl7DYGrMqkeWdOtGRv" target="_blank">
                <div class="bg-white rounded-xl p-4 lg:p-6 shadow text-center">
                    <div class="text-2xl lg:text-3xl text-yellow-500 font-bold mb-2">
                        <i class="fas fa-calendar-alt"></i>
                    </div>
                    <div class="text-gray-500 text-sm lg:text-base font-bold">BSEE</div>
                </div>
                </a>

                <a href="https://drive.google.com/drive/folders/12NPxnvMqIUlCgTDUnL1LiaMlYSwbb8KA" target="_blank">
                <div class="bg-white rounded-xl p-4 lg:p-6 shadow text-center">
                    <div class="text-2xl lg:text-3xl text-pink-500 font-bold mb-2">
                        <i class="fas fa-calendar-alt"></i>
                    </div>
                    <div class="text-gray-500 text-sm lg:text-base font-bold">BSME</div>
                </div>
                </a>
