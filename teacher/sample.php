...
// Function to convert year level to numeric format
...
// Function to get registered students count for a specific subject and class
...
// Function to get unique sections for a program and year
    ...
    <div class="flex-1 flex flex-col xl:flex-row xl:ml-64">
        ...
        <div class="flex-1 flex flex-col m-2 lg:m-5">
            ...
            <div class="flex items-center justify-between mb-6 gap-4">
                <div class="flex items-center gap-4 flex-1">
                    ...
                    <!-- Search Bar -->
                    <input type="text" class="bg-white rounded-full px-4 py-2 shadow w-full max-w-xs" placeholder="Search">
                </div>
        ...
        <div class="bg-white rounded-xl shadow-lg p-6">
            <div class="flex justify-between items-center mb-6">
                <h1 class="text-2xl font-bold text-green-600">My Classes</h1>
                <a href="teacher_dashboard.php" class="inline-flex items-center px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700">
